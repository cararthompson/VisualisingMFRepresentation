...
Using the sentence split performed in the Gender Balance tab, this first graph shows the emotions associated with words in each of the three sentence groups. The emotions associated with each word are taken from the commonly used NCR lexicon. 
